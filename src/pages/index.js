...
const Blog = () => {
  ...
  return (
    <Layout>
      <SEO title="Blog" />
      <div>
        <p className="text-center font-thin text-md border border-gray-200">Bienvenido a mi blog personal, en el cual encontraras temas relacionado con la programación web</p>
      </div>
